...
推荐阅读，搜索页(结果列表的筛选)，书籍详情（分享功能隐藏，还有bug）

#### 活动，消息资源

通知公告，最新资源，活动日历（**未完成**）
跳转公众号文章（**未完成**）[小程序获取公众文章](https://zhuanlan.zhihu.com/p/551116565?utm_id=0)

#### 个人中心

登录/绑定账号，用户信息，借阅记录，关于，意见反馈，
设置（多语言，清除缓存，设置主题，**未完成**）
超期提醒（**未完成**）
...
- 主包
  home,activity,resources,center
...
## 其他
- 配置业务域名
  要跳转到其他页面，使用web-view需要配置业务域名
  将下载的校验文件，放到目标地址的服务器的根路径下
  [业务域名配置](https://developers.weixin.qq.com/community/develop/doc/00084a350b426099ab46e0e1a50004?%2Fblogdetail%3Faction=get_post_info)
  
- 体验评分
  开发者工具 - 详情 - 性能质量 - 体验评分
- 主题色：#142d88 
- 写发布日志 log.md
- uni组件库部分组件有所改动，代码必须保留uni_modules的内容
	
	不完全统计修改过的组件：tag, card, segmented-control，
- 不要随意删除某一行代码
